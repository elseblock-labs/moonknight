...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar='header'
      className={cn('flex flex-col gap-2 p-2 pb-8', className)}
      {...props}
    />
  )
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar='group'
      className={cn('relative flex w-full min-w-0 flex-col p-2 py-4 group-data-[collapsible=icon]:px-2 group-data-[collapsible=icon]:py-4', className)}
      {...props}
    />
  )
}
